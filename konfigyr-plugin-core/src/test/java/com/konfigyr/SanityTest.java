        ...
        assertThat(descriptors)
                ...
                .satisfiesExactly(
                        it -> PropertyDescriptorAssert.assertThat(it)
                                ...
                                .schema(ArraySchema.builder().items(StringSchema.builder().format(KonfigyrFormat.IPV4).build()).build())
                        ...
                        it -> PropertyDescriptorAssert.assertThat(it)
                                ...
                                .schema(ArraySchema.builder().items(StringSchema.builder().format(KonfigyrFormat.IPV6).build()).build())
                                ...
                                .schema(ObjectSchema.builder()
                                        ...
                                        .additionalProperties(
                                                ObjectSchema.builder()
                                                        .property("key", StringSchema.builder().format(KonfigyrFormat.URI).build())
                                                        .property("size", StringSchema.builder().format(KonfigyrFormat.DATA_SIZE).build())
                                                        .property("ttl", StringSchema.builder().format(KonfigyrFormat.DURATION).build())
                        ...
                        it -> PropertyDescriptorAssert.assertThat(it)
                                ...
                                .schema(ObjectSchema.builder()
                                        ...
                                        .additionalProperties(
                                                ObjectSchema.builder()
                                                        .property("date", StringSchema.builder().format(KonfigyrFormat.DATE).build())
                                                        .property("dateTime", StringSchema.builder().format(KonfigyrFormat.DATE_TIME).build())
                                                        .property("name", StringSchema.instance())
                                                        .property("resource", StringSchema.builder().format(KonfigyrFormat.RESOURCE).build())
                                                        .property("size", StringSchema.builder().format(KonfigyrFormat.DATA_SIZE).build())
                                                        .property("time", StringSchema.builder().format(KonfigyrFormat.TIME).build())
                                                        .build()
                                        ).build()
                                )
                        ...
                        it -> PropertyDescriptorAssert.assertThat(it)
                                ...
                                .schema(StringSchema.builder().format(KonfigyrFormat.MIME_TYPE).build())
                        ...
                        it -> PropertyDescriptorAssert.assertThat(it)
                                ...
                                .schema(StringSchema.builder().format(KonfigyrFormat.RESOURCE).build())
                        ...
                        it -> PropertyDescriptorAssert.assertThat(it)
                                ...
                                .schema(IntegerSchema.builder().format(KonfigyrFormat.INT32).build())
